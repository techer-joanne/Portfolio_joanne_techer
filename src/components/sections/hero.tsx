...
export function Hero() {
  ...
  const titleSize = isMobile ? "text-4xl sm:text-5xl" : "text-6xl sm:text-7xl";
        ...
        >
          <div className="relative inline-block">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className={`bg-gradient-to-r from-blue-500 via-blue-400 to-blue-300 bg-clip-text font-bold tracking-tight text-transparent ${titleSize}`}
            >
